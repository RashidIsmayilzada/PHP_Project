            ...
            <div class="card-body p-4">
                <form method="POST" action="/teacher/assignment-create/<?= htmlspecialchars((string) $courseId) ?>">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg <?= !empty($errors['assignment_name']) ? 'is-invalid' : '' ?>" id="assignment_name" name="assignment_name" required placeholder="e.g., Homework 1: Introduction to Logic" value="<?= htmlspecialchars($formData['assignment_name'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?= !empty($errors['description']) ? 'is-invalid' : '' ?>" id="description" name="description" rows="4" placeholder="Instructions for students..." required><?= htmlspecialchars($formData['description'] ?? '') ?></textarea>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control <?= !empty($errors['max_points']) ? 'is-invalid' : '' ?>" id="max_points" name="max_points" step="0.5" required value="<?= htmlspecialchars($formData['max_points'] ?? '100.0') ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control <?= !empty($errors['due_date']) ? 'is-invalid' : '' ?>" id="due_date" name="due_date" required value="<?= htmlspecialchars($formData['due_date'] ?? '') ?>">
